...
public class CardManagerScr : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        CardManager.AllCards.Add(new Card("provacation", "Sprites/Cards/Provacation", 2, 20, 4, Card.AbilityType.PROVACATION));
        CardManager.AllCards.Add(new Card("regeneration", "Sprites/Cards/Regeneration", 4, 4, 4, Card.AbilityType.REGENERATION_EACH_TURN));
        CardManager.AllCards.Add(new Card("doubleAttack", "Sprites/Cards/DB_Attack", 3, 15, 7, Card.AbilityType.DOUBLE_ATTACK));
        CardManager.AllCards.Add(new Card("instantActive", "Sprites/Cards/I_Active", 20, 20, 10, Card.AbilityType.INSTANT_ACTIVE));
